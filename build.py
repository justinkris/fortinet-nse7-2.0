...
const VALID_SECTIONS = new Set(['progress','phase-01','phase-02','phase-03','phase-04','phase-05','phase-06','phase-07','phase-08','roadmap','objective-map','journey']);
const DEFAULT_SECTION = 'progress';
